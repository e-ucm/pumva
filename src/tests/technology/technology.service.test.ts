import { createTechnology, getTechnologies, getTechnologyById, updateTechnologies, updateTechnology, deleteTechnologies, deleteTechnologyById } from "@/services/games/technology.service";
